...
Citizen.CreateThread(function()
	while Koaio.Global.isFirstSpawn do
		Citizen.Wait(10)
		Koaio.Global.isFirstSpawn = exports['spawnmanager']:isFirstSpawn()
	end
	...
	while true do
		...
		if Player.Init and not Koaio.Global.isFirstSpawn then
			Player.Init = nil
			TriggerEvent('Koaio:init', Player)
		end

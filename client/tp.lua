...
Koaio.newThread(function ()
    while true do
        ...
        for _,location in ipairs(Koaio.positions) do
            ...
            Green = location[3][2]
            Blue = location[3][3]
            local vector = vector3(loc1.x, loc1.y, loc1.z)
            local vector2 = vector3(loc2.x, loc2.y, loc2.z)
            if #(playerLoc - vector) < 7 then
                interval = 0
                DrawMarker(1, loc1.x, loc1.y, loc1.z, 0, 0, 0, 0, 0, 0, 1.501, 1.5001, 0.5001, Red, Green, Blue, 200, 0, 0, 0, 0)
            end
            if #(playerLoc - vector2) < 7 then
                interval = 0

            ...
            while isNameShown do
                ...
                for _, player in pairs(GetActivePlayers()) do
                    ...
                    if ped ~= plyPed then
                       ...
                       if #(GetEntityCoords(plyPed, false) - GetEntityCoords(ped, false)) < 30000000000.0 then
...
function NoClip(bool)
    ...
    if not isStaffMode then
        exports['K_jobs']:Alert("Admin", "Vous devez avoir le staff mode activé pour faire cela", 5000, 'Admin')

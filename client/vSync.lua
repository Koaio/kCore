...
Koaio.netRegisterAndHandle('vSync:updateWeather', function(NewWeather, newblackout)
...
Koaio.netRegisterAndHandle('vSync:updateTime', function(base, offset, freeze)
    freezeTime = freeze
    timeOffset = offset
    baseTime = base
end)
...
Koaio.netRegisterAndHandle('playerSpawned', function()
    KoaioClientUtils.toServer('vSync:requestSync')
end)
...
Koaio.netRegisterAndHandle('vSync:notify', function(message, blink)
